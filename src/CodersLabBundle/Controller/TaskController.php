...
use CodersLabBundle\Form\TaskType;
...
///robimy analogicznie
     ...
     * @Method("POST")
     * @Template("CodersLabBundle:Task:new.html.twig")
     */
    public function createAction(Request $request)
    {
        $entity = new Task();
        $owner = $this->getUser();
        $entity->setUserTask($owner);
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CodersLabBundle:Task')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CodersLabBundle:Task:edit.html.twig")
     */
